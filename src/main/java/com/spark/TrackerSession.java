...
public class TrackerSession extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static com.spark.TrackerSession.Builder newBuilder() {
    return new com.spark.TrackerSession.Builder();
  }
  
  /** Creates a new TrackerSession RecordBuilder by copying an existing Builder */
  public static com.spark.TrackerSession.Builder newBuilder(com.spark.TrackerSession.Builder other) {
    return new com.spark.TrackerSession.Builder(other);
  }
  
  /** Creates a new TrackerSession RecordBuilder by copying an existing TrackerSession instance */
  public static com.spark.TrackerSession.Builder newBuilder(com.spark.TrackerSession other) {
    return new com.spark.TrackerSession.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<TrackerSession>
    ...
    private Builder() {
      super(com.spark.TrackerSession.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.spark.TrackerSession.Builder other) {
      super(other);
    ...
    private Builder(com.spark.TrackerSession other) {
            super(com.spark.TrackerSession.SCHEMA$);
      if (isValidValue(fields()[0], other.session_id)) {
        this.session_id = data().deepCopy(fields()[0].schema(), other.session_id);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'session_id' field */
    public com.spark.TrackerSession.Builder setSessionId(java.lang.CharSequence value) {
    ...
    public com.spark.TrackerSession.Builder clearSessionId() {
      session_id = null;
    ...
    /** Sets the value of the 'session_server_time' field */
    public com.spark.TrackerSession.Builder setSessionServerTime(java.lang.CharSequence value) {
    ...
    public com.spark.TrackerSession.Builder clearSessionServerTime() {
    ...
    /** Sets the value of the 'cookie' field */
    public com.spark.TrackerSession.Builder setCookie(java.lang.CharSequence value) {
    ...
    public com.spark.TrackerSession.Builder clearCookie() {
      cookie = null;
    ...
    /** Sets the value of the 'cookie_label' field */
    public com.spark.TrackerSession.Builder setCookieLabel(java.lang.CharSequence value) {
    ...
    public com.spark.TrackerSession.Builder clearCookieLabel() {
      cookie_label = null;
    ...
    /** Sets the value of the 'ip' field */
    public com.spark.TrackerSession.Builder setIp(java.lang.CharSequence value) {
    ...
    public com.spark.TrackerSession.Builder clearIp() {
      ip = null;
    ...
    /** Sets the value of the 'landing_url' field */
    public com.spark.TrackerSession.Builder setLandingUrl(java.lang.CharSequence value) {
    ...
    public com.spark.TrackerSession.Builder clearLandingUrl() {
      landing_url = null;
    ...
    /** Sets the value of the 'pageview_count' field */
    public com.spark.TrackerSession.Builder setPageviewCount(int value) {
    ...
    public com.spark.TrackerSession.Builder clearPageviewCount() {
    ...
    /** Sets the value of the 'click_count' field */
    public com.spark.TrackerSession.Builder setClickCount(int value) {
    ...
    public com.spark.TrackerSession.Builder clearClickCount() {
    ...
    /** Sets the value of the 'domain' field */
    public com.spark.TrackerSession.Builder setDomain(java.lang.CharSequence value) {
    ...
    public com.spark.TrackerSession.Builder clearDomain() {
      domain = null;
    ...
    /** Sets the value of the 'domain_label' field */
    public com.spark.TrackerSession.Builder setDomainLabel(java.lang.CharSequence value) {
    ...
    public com.spark.TrackerSession.Builder clearDomainLabel() {
      domain_label = null;
