...
public class TrackerLog extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"TrackerLog\",\"namespace\":\"com.spark\",\"fields\":[{\"name\":\"log_type\",\"type\":\"string\"},{\"name\":\"log_server_time\",\"type\":\"string\"},{\"name\":\"cookie\",\"type\":\"string\"},{\"name\":\"ip\",\"type\":\"string\"},{\"name\":\"url\",\"type\":\"string\"}]}");
  ...
  public static com.spark.TrackerLog.Builder newBuilder() {
    return new com.spark.TrackerLog.Builder();
  }
  
  /** Creates a new TrackerLog RecordBuilder by copying an existing Builder */
  public static com.spark.TrackerLog.Builder newBuilder(com.spark.TrackerLog.Builder other) {
    return new com.spark.TrackerLog.Builder(other);
  }
  
  /** Creates a new TrackerLog RecordBuilder by copying an existing TrackerLog instance */
  public static com.spark.TrackerLog.Builder newBuilder(com.spark.TrackerLog other) {
    return new com.spark.TrackerLog.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<TrackerLog>
    ...
    private Builder() {
      super(com.spark.TrackerLog.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.spark.TrackerLog.Builder other) {
      super(other);
    ...
    private Builder(com.spark.TrackerLog other) {
            super(com.spark.TrackerLog.SCHEMA$);
      if (isValidValue(fields()[0], other.log_type)) {
        this.log_type = data().deepCopy(fields()[0].schema(), other.log_type);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'log_type' field */
    public com.spark.TrackerLog.Builder setLogType(java.lang.CharSequence value) {
    ...
    public com.spark.TrackerLog.Builder clearLogType() {
      log_type = null;
    ...
    /** Sets the value of the 'log_server_time' field */
    public com.spark.TrackerLog.Builder setLogServerTime(java.lang.CharSequence value) {
    ...
    public com.spark.TrackerLog.Builder clearLogServerTime() {
    ...
    /** Sets the value of the 'cookie' field */
    public com.spark.TrackerLog.Builder setCookie(java.lang.CharSequence value) {
    ...
    public com.spark.TrackerLog.Builder clearCookie() {
      cookie = null;
    ...
    /** Sets the value of the 'ip' field */
    public com.spark.TrackerLog.Builder setIp(java.lang.CharSequence value) {
    ...
    public com.spark.TrackerLog.Builder clearIp() {
      ip = null;
    ...
    /** Sets the value of the 'url' field */
    public com.spark.TrackerLog.Builder setUrl(java.lang.CharSequence value) {
    ...
    public com.spark.TrackerLog.Builder clearUrl() {
      url = null;
